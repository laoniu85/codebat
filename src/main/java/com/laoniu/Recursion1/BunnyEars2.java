...
public class BunnyEars2 {
    ...
    /*
        ...
        The odd bunnies (1, 3, ..)
         ...
         Recursively return the number of "ears"
...
/*
    public int bunnyEars2(int bunnies){
        if (bunnies % 2 == 0) {
            return bunnies == 0 ? 0 : 3 + bunnyEars2(bunnies - 1);
        } else {
    ...
    */
    ...
    public void testBunnyEars2() {
        assertEquals(bunnyEars2(0), 0);
        assertEquals(bunnyEars2(1), 2);
        assertEquals(bunnyEars2(2), 5);
    }
}
